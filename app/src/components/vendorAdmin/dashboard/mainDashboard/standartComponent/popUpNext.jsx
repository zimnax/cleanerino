...
const PopUpNext = ({ startNewProd, cancelFromProd }) => {
  return (
    <div className={css.wrapPopUp}>
      <div className={css.popWr}>
        ...
        <p className={css.pFirstP}>Your product has been added to Cleanerino</p>
        <div className={css.wrapButtonPop}>
          <button className={css.buttonAddMore} onClick={startNewProd}>
            Add more product
          </button>
          <button className={css.nextPage} onClick={cancelFromProd}>
            Customize store
          </button>
        </div>
      </div>
