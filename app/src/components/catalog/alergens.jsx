...
// const Alergens = ({ setAlergens, alergens }) => {
...
const Alergens = ({ setAlergens, alergens }) => {
  ...
  const isCategorySelected = (categoryName) => {
    return alergens && alergens.includes(categoryName);
  };

  const handleCategoryChange = (categoryName) => {
    const updatedSelectedCategories = alergens.includes(categoryName)
      ? alergens.filter((cat) => cat !== categoryName)
      : [...alergens, categoryName];
  ...
  return (
    <div className={css.wrapAllFilter}>
      ...
      {isDropdownOpen && (
        <div className={css.dropdown}>
          <div className={css.dropdownItem} onClick={() => setAlergens([])}>
            <div className={css.kvad}></div>
            <p className={css.nameLocP}>All</p>
          </div>
          {categories.map((category, index) => (
