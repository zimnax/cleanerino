...
import VendorsProd from "./vendorsProd";
    ...
    <>
      {prodList && (
        <div className={css.productListWrap}>
          <p className={css.productPInProd}>Products</p>
                ...
                <table className={css.tableProd}>
                  <thead>
                    <tr className={css.mainTr}>
                      ...
                      <th className={css.thClass}>Name vendor</th>
                          ...
                          return (
                            <>
                              <tr className={css.secondTr} key={index}>
                                ...
                                <VendorsProd vendorId={el.vendorId} />
                                <td className={css.tdClassProd}>
                                  {categoryName}
                                </td>
                                <td className={css.tdClassProd}>
                              ...
                              <div className={css.lineForProd}></div>
                            </>
                          );
                        })}
                  </tbody>
