...
const Ingridients = ({
  ...
  const isCategorySelected = (categoryName) => {
    return selectedIngridient.includes(categoryName);
  };

  const handleCategoryChange = (categoryName) => {
    const updatedSelectedCategories = selectedIngridient.includes(categoryName)
      ? selectedIngridient.filter((cat) => cat !== categoryName)
      : [...selectedIngridient, categoryName];
